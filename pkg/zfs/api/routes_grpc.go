...
func RegisterZFSGRPCHandlers(poolHandler *PoolHandler, datasetHandler *DatasetHandler) {
	...
	client.RegisterCommandHandler(CmdPoolDeviceRemove, handlePoolDeviceRemove(poolHandler))
	client.RegisterCommandHandler(CmdPoolDeviceOffline, handlePoolDeviceOffline(poolHandler))
	client.RegisterCommandHandler(CmdPoolDeviceOnline, handlePoolDeviceOnline(poolHandler))
	client.RegisterCommandHandler(CmdPoolAdd, handlePoolAdd(poolHandler))
	client.RegisterCommandHandler(CmdPoolClear, handlePoolClear(poolHandler))
	client.RegisterCommandHandler(CmdPoolInitialize, handlePoolInitialize(poolHandler))
	client.RegisterCommandHandler(CmdPoolTrim, handlePoolTrim(poolHandler))
	client.RegisterCommandHandler(CmdPoolCheckpoint, handlePoolCheckpoint(poolHandler))
	client.RegisterCommandHandler(CmdPoolReguid, handlePoolReguid(poolHandler))
	client.RegisterCommandHandler(CmdPoolReopen, handlePoolReopen(poolHandler))
	client.RegisterCommandHandler(CmdPoolUpgrade, handlePoolUpgrade(poolHandler))
	client.RegisterCommandHandler(CmdPoolHistory, handlePoolHistory(poolHandler))
	client.RegisterCommandHandler(CmdPoolEvents, handlePoolEvents(poolHandler))
	client.RegisterCommandHandler(CmdPoolIOStat, handlePoolIOStat(poolHandler))
	client.RegisterCommandHandler(CmdPoolWait, handlePoolWait(poolHandler))
	client.RegisterCommandHandler(CmdPoolSplit, handlePoolSplit(poolHandler))
	client.RegisterCommandHandler(CmdPoolLabelClear, handlePoolLabelClear(poolHandler))
	client.RegisterCommandHandler(CmdPoolSync, handlePoolSync(poolHandler))
	...
	client.RegisterCommandHandler(CmdTransferGet, handleManagedTransferGet(datasetHandler))
	client.RegisterCommandHandler(CmdTransferPause, handleManagedTransferPause(datasetHandler))
	client.RegisterCommandHandler(CmdTransferResume, handleManagedTransferResume(datasetHandler))
	client.RegisterCommandHandler(CmdTransferStop, handleManagedTransferStop(datasetHandler))
	client.RegisterCommandHandler(CmdTransferDelete, handleManagedTransferDelete(datasetHandler))
