...
var errorDefinitions = map[ErrorCode]struct {
	...
	ZFSDatasetGetProperty:      {"Failed to get dataset property", DomainZFS, http.StatusBadRequest},
	ZFSDatasetSetProperty:      {"Failed to set dataset property", DomainZFS, http.StatusBadRequest},
	...
	ZFSSnapshotFailed:          {"Failed to create/manage snapshot", DomainZFS, http.StatusBadRequest},
	...
	ZFSPoolDeviceOperation:  {"Failed to perform zpool device operation", DomainZFS, http.StatusBadRequest},
